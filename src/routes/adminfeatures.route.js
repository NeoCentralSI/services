...
const ACADEMIC_YEAR_LIST_ROLES = [
  ...new Set([
    ROLES.ADMIN,
...
router.get("/audit-logs", authGuard, requireRole(ROLES.ADMIN), getAdminAuditLogsController);
...
router.get("/academic-years", authGuard, requireAnyRole(ACADEMIC_YEAR_LIST_ROLES), getAcademicYearsController);
