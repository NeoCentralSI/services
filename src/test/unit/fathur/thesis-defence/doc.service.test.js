...
const { mockDocRepo, mockCoreRepo, mockPrisma, mockLecturerRepo } = vi.hoisted(() => ({
  ...
  mockPrisma: {
    ...
    academicYear: { findFirst: vi.fn().mockResolvedValue({ id: "ay1", name: "2025/2026 Ganjil" }) },
  },
  mockLecturerRepo: {
...
describe("Defence Document Service (Full Alignment)", () => {
  beforeEach(() => {
    ...
    mockPrisma.academicYear.findFirst.mockResolvedValue({ id: "ay1", name: "2025/2026 Ganjil" });
  });
