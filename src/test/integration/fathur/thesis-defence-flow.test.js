...
describe("Integration: Thesis Defence Flow (Registration to Finalization)", () => {
  ...
  let defenceId, requirements, thesisCpmk, criteriaExaminer, criteriaSupervisor;
  ...
  beforeAll(async () => {
    try {
      ...
      if (requirements.length === 0) throw new Error("Defence requirements must be configured for the active academic year");
